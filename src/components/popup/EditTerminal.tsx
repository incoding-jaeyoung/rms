...
export default function EditTerminal({ open, onClose }: EditTerminalProps) {
  ...
  return (
    <Modal
      ...
      title="Edit Terminal Information"
      size="default"
      confirmText="Save Chages"
      cancelText="Cancel"
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        <Space direction="vertical" size={20} className="w-full">
          ...
          <Form.Item name="notes" label="Reason for change">
            <TextArea rows={3} placeholder="enter reason for this change " />
          </Form.Item>
          <Space size={20}>
            <Form.Item
              name="createdAt"
